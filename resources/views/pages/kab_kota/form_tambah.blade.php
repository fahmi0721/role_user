@extends("master_lte")
@section("title-page", "Tambah Master Kabupaten / Kota")

@section('breadcrumb')
<section class="content-header">
  <h1>
    Kabupaten / Kota
    <small>Tambah Master Kabupaten / Kota</small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="{{ url('kab-kota') }}"><i class="fa fa-tags"></i> Kabupaten / Kota</a></li>
    <li class="active"><i class="fa fa-plus-square"></i> Tambah Master Kabupaten / Kota</li>
  </ol>
</section>
@endsection
...
<div class="box box-success">
    <div class="box-header with-border ">
        <h3 class="box-title"><i class='fa fa-plus-square text-success'></i> Tambah Data Kabupaten / Kota</h3>
    ...
    <div class="box-body">
        <form action="javascript:void(0)" id='FormData'>
            ...
            <div class="form-group">
                ...
                <input type="text" placeholder="Entri Nama Kabupaten / Kota" name='nama_kab_kota' id='nama_kab_kota' class='form-control'>
            </div>
            <div class="form-group">
