@extends("master_lte")
@section("title-page", "Ubah Master Jenis Mitra")
...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active"><i class="fa fa-plus-square"></i> Ubah Master Jenis Mitra</li>
  </ol>
</section>
@endsection
...
<div class="box box-success">
    <div class="box-header with-border ">
        <h3 class="box-title"><i class='fa fa-plus-square text-success'></i> Ubah Data Jenis Mitra</h3>
    ...
    <div class="box-body">
        <form action="javascript:void(0)" id='FormData'>
            ...
            <div class="form-group">
                ...
                <input type="text" placeholder="Entri Jenis Mitra" value="{{ $data->nama_jenis_mitra }}"  name='nama_jenis_mitra' id='nama_jenis_mitra' class='form-control FormIsi'>
            </div>
            <div class="form-group">
                <label for="deskripsi" class='control-label'>Deskpripsi</label>
                <textarea type="text" placeholder="Entri Penjelasan Jenis Mitra"  name='deskripsi' id='deskripsi' class='form-control' rows='8'>{{ $data->nama_jenis_mitra }}</textarea>
            </div>
