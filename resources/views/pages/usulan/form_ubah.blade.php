@extends("master_lte")
@section("title-page", "Ubah Usulan")
...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active"><i class="fa fa-edit"></i> Ubah Usulan</li>
  </ol>
</section>
@endsection
...
<div class="box box-success">
    <div class="box-header with-border ">
        <h3 class="box-title"><i class='fa fa-edit text-success'></i> Ubah Data Usulan</h3>
        ...
        <form action="javascript:void(0)" id='FormData'>
            ...
            <div class="form-group">
                ...
                <select name="id_unit" id="id_unit"  class="form-control select-unit">
                    ...
                    @foreach($unit as $key => $dt_unit)
                        <option  value="{{ $dt_unit->id }}" @if($data->id_unit == $dt_unit->id) selected @endif >{{ $dt_unit->nama_unit }}</option>
            ...
            <div class="form-group">
                ...
                <select name="id_jenis_kerjasama" id="id_jenis_kerjasama"  class="form-control select-jenis-kerjasama">
                    ...
                    @foreach($jenis_kerjasama as $key => $dt_jenis_kerjasama)
                        <option  value="{{ $dt_jenis_kerjasama->id }}" @if($data->id_jenis_kerjasama == $dt_jenis_kerjasama->id) selected @endif>{{ $dt_jenis_kerjasama->nama_jenis_kerjasama }}</option>
            ...
            <div class="form-group">
                ...
                <select name="id_mitra" id="id_mitra"  class="form-control select-mitra">
                    ...
                    @foreach($mitra as $key => $dt_mitra)
                        <option  value="{{ $dt_mitra->id }}" @if($data->id_mitra == $dt_mitra->id) selected @endif>{{ $dt_mitra->nama_mitra }}</option>
            ...
            <div class="form-group">
                ...
                <select name="id_bentuk_kerjasama" id="id_bentuk_kerjasama"  class="form-control select-bentuk-kerjasama">
                    ...
                    @foreach($bentuk_kerjasama as $key => $dt_bentuk_kerjasama)
                        <option  value="{{ $dt_bentuk_kerjasama->id }}" @if($data->id_bentuk_kerjasama == $dt_bentuk_kerjasama->id) selected @endif>{{ $dt_bentuk_kerjasama->nama_bentuk_kerjasam_detail }}</option>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" placeholder="Entri Tanggal Usul" value="{{ $data->tanggal_usul }}"  name='tanggal_usul' id='tanggal_usul' class='form-control datepicker'>
            ...
            <div class="form-group">
                ...
                <input type="text" rows='3' placeholder="Entri Deskripsi" name='deskripsi' id='deskripsi' class='form-control' value="{{ $data->deskripsi }}">
            </div>
