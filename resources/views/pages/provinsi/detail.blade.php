@extends("master_lte")
@section("title-page", "Master Provinsi")
...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    <li class="active"><i class="fa fa-tags"></i> Provinsi</li>
  </ol>
</section>
@endsection
...
$cek_menu_akses = Custom::cek_akses_menu('provinsi',json_decode(Session::get('menu_akses'),true));
@endphp
<!-- Default box -->
<div class="box box-success">
    <div class="box-header with-border ">
        <h3 class="box-title"><i class='fa fa-archive text-success'></i> Data Provinsi</h3>
        <div class="box-tools pull-right">
            @if($cek_menu_akses['status_tambah'] == '1')
            <a  href="{{ url('provinsi/add') }}" class='btn btn-sm btn-success' data-toggle='tooltip' title='Tmbah Data Provinsi'><i class="fa fa-plus-square"></i> Tambah</a>
            @endif
        </div>
    </div>
    <div class="box-body">
        <div class='table-responsive'>
            <table class='table table-striped table-bordered' id="provinsi-table">
                <thead>
                    <tr>
            ...
            columns: [
                ...
                { data: 'id', name: 'aksi',"orderable": false, className: "text-center", 'searchable':false, render: function (data, type, row, meta) {
                    ...
                    @if($cek_menu_akses['status_edit'] == '1')
                        var edit = "<div class='btn btn-group'><a class='btn btn-xs btn-primary' data-toggle='tooltip' href='{{ url('provinsi/ubah') }}/"+row.id+"' title='Edit Data'><i class='fa fa-pencil'></i></a> ";
                    @endif
