@extends("master_lte")
@section("title-page", "Tambah Master Provinsi")

@section('breadcrumb')
<section class="content-header">
  <h1>
    Provinsi
    <small>Tambah Master Provinsi</small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="{{ url('provinsi') }}"><i class="fa fa-tags"></i> Provinsi</a></li>
    <li class="active"><i class="fa fa-plus-square"></i> Tambah Master Provinsi</li>
  </ol>
</section>
@endsection
...
<div class="box box-success">
    <div class="box-header with-border ">
        <h3 class="box-title"><i class='fa fa-plus-square text-success'></i> Tambah Data Provinsi</h3>
    ...
    <div class="box-body">
        <form action="javascript:void(0)" id='FormData'>
            ...
            <div class="form-group">
                ...
                <input type="text" placeholder="Entri Nama Provinsi" name='nama_provinsi' id='nama_provinsi' class='form-control FormIsi'>
            </div>
            <div class="form-group">
