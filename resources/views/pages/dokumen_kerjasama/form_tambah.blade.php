@extends("master_lte")
@section("title-page", "Tambah Dokumen Kerjasama")
...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active"><i class="fa fa-plus-square"></i> Tambah Dokumen Kerjasama</li>
  </ol>
</section>
@endsection
...
<div class="box box-success">
    <div class="box-header with-border ">
        <h3 class="box-title"><i class='fa fa-plus-square text-success'></i> Tambah Data Dokumen Kerjasama</h3>
    ...
    <div class="box-body">
        <form action="javascript:void(0)" id='FormData'>
            ...
            <div class="form-group">
                ...
                <select name="id_usulan" id="id_usulan"  class="form-control select-usulan" onchange="get_detail_data_usulan(this.value)">
                    ...
                    @foreach($usulan as $key => $dt_usulan)
                        <option  value="{{ $dt_usulan->id }}">{{ $dt_usulan->deskripsi }}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" placeholder="Entri Unit" readonly name='unit' id='unit' class='form-control'>
            </div>

            <div class="form-group">
                <label for="mitra" autocomplete=off class='control-label'>Mitra</label>
                <input type="text" placeholder="Entri Mitra" readonly name='mitra' id='mitra' class='form-control'>
            </div>

            <div class="form-group">
                <label for="bentuk_kerjasama" autocomplete=off class='control-label'>Bentuk Kerjasama</label>
                <input type="text" placeholder="Entri Bentuk Kerjasama" readonly name='bentuk_kerjasama' id='bentuk_kerjasama' class='form-control'>
            </div>

            <div class="form-group">
                <label for="jenis_kerjasama" autocomplete=off class='control-label'>Jenis Kerjasama</label>
                <input type="text" placeholder="Entri Jenis Kerjasama" readonly name='jenis_kerjasama' id='jenis_kerjasama' class='form-control'>
            </div>
            
            <div class="form-group">
                <label for="nama_dokumen" autocomplete=off class='control-label'>Nama Dokumen <span class='text-danger'>*</span></label>
                <input type="text" placeholder="Entri Nama Dokumen" name='nama_dokumen' id='nama_dokumen' class='form-control'>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="text" placeholder="Entri Tanggal Dari" name='tgl_awal' id='tgl_awal' class='form-control date_awal'>
                    <span class='input-group-addon'>S/D</span>
                    <input type="text" placeholder="Entri Tanggal Sampai" name='tgl_akhir' id='tgl_akhir' class='form-control date_akhir'>
                    <span class='input-group-addon'><i class='fa fa-calendar'></i></span>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea type="text" placeholder="Entri Deskripsi" rows='4' name='deskripsi' id='deskripsi' class='form-control'></textarea>
            </div>
