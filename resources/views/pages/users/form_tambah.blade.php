@extends("master_lte")
@section("title-page", "Tambah Master Users")

@section('breadcrumb')
<section class="content-header">
  <h1>
    Users
    <small>Tambah Master Users</small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="{{ url('users') }}"><i class="fa fa-book"></i> Users</a></li>
    <li class="active"><i class="fa fa-plus-square"></i> Tambah Master Users</li>
  </ol>
</section>
@endsection
...
<div class="box box-success">
    <div class="box-header with-border ">
        <h3 class="box-title"><i class='fa fa-plus-square text-success'></i> Tambah Data Users</h3>
    ...
    <div class="box-body">
        <form action="javascript:void(0)" id='FormData'>
            ...
            <div class="form-group">
                ...
                <input type="text" placeholder="Entri Nama User" name='nama_user' id='nama_user' class='form-control'>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="text" placeholder="Entri Username"  name='username' id='username' class='form-control'>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <span class='input-group-addon'><input type="radio" name="level" class="flat-red" value="admin" checked></span>
                    <input type="text" readonly class='form-control' value='Admin'>
                    <span class='input-group-addon'><input type="radio" name="level" class="flat-red" value="member"></span>
