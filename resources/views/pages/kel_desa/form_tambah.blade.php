@extends("master_lte")
@section("title-page", "Tambah Master Kelurahan / Desa")

@section('breadcrumb')
<section class="content-header">
  <h1>
    Kelurahan / Desa
    <small>Tambah Master Kelurahan / Desa</small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="{{ url('kel-desa') }}"><i class="fa fa-tags"></i> Kelurahan / Desa</a></li>
    <li class="active"><i class="fa fa-plus-square"></i> Tambah Master Kelurahan / Desa</li>
  </ol>
</section>
@endsection
    ...
    <div class="box-body">
        <form action="javascript:void(0)" id='FormData'>
            ...
            <div class="form-group">
                ...
                <input type="text" placeholder="Entri Nama Kelurahan / Desa" name='nama_kel_desa' id='nama_kel_desa' class='form-control'>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" placeholder="Entri Nama Kecamatan" name='kode_pos' id='kode_pos' class='form-control'>
            </div>
            <div class="form-group">
