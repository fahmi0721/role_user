@extends("master_lte")
@section("title-page", "Ubah Master Bentuk Kerja Sama Detail")
...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active"><i class="fa fa-edit"></i> Ubah Master Bentuk Kerja Sama Detail</li>
  </ol>
</section>
@endsection
...
<div class="box box-success">
    <div class="box-header with-border ">
        <h3 class="box-title"><i class='fa fa-edit text-success'></i> Ubah Data Bentuk Kerjasama Detail</h3>
    ...
    <div class="box-body">
        <form action="javascript:void(0)" id='FormData'>
            ...
            <div class="form-group">
                ...
                <input type="text" value="{{ $data->nama_bentuk_kerjasam_detail }}" placeholder="Entri Bentuk Kerjasama Detail" name='nama_bentuk_kerjasam_detail' id='nama_bentuk_kerjasam_detail' class='form-control FormIsi'>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="id_bentuk_kerjasama_umum" id="id_bentuk_kerjasama_umum"  class="form-control select-bksu">
                    ...
                    @foreach($bksu as $key => $dt_bksu)
                        <option  value="{{ $dt_bksu->id }}" @if($data->id_bentuk_kerjasama_umum == $dt_bksu->id) selected @endif>{{ $dt_bksu->nama_bentuk_kerjasam_umum }}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea type="text" placeholder="Entri Penjelasan Bentuk Kerjasama Detail"  name='rincian_bentuk_kerjasam_detail' id='rincian_bentuk_kerjasam_detail' class='form-control' rows='8'>{{ $data->rincian_bentuk_kerjasam_detail }}</textarea>
            </div>
