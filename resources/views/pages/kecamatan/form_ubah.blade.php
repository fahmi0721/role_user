@extends("master_lte")
@section("title-page", "Ubah Master Kecamatan")

@section('breadcrumb')
<section class="content-header">
  <h1>
    Kecamatan
    <small>Ubah Master Kecamatan</small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="{{ url('kecamatan') }}"><i class="fa fa-tags"></i> Kecamatan</a></li>
    <li class="active"><i class="fa fa-edit"></i> Ubah Master Kecamatan</li>
  </ol>
</section>
@endsection
    ...
    <div class="box-body">
        <form action="javascript:void(0)" id='FormData'>
            ...
            <div class="form-group">
                ...
                <input type="text" value="{{ $data->nama_kecamatan }}" placeholder="Entri Nama Kecamatan" name='nama_kecamatan' id='nama_kecamatan' class='form-control'>
            </div>
            <div class="form-group">
