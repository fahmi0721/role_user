@extends("master_lte")
@section("title-page", "Tambah Mitra")
...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active"><i class="fa fa-plus-square"></i> Tambah Mitra</li>
  </ol>
</section>
@endsection
...
<div class="box box-success">
    <div class="box-header with-border ">
        <h3 class="box-title"><i class='fa fa-plus-square text-success'></i> Tambah Data Mitra</h3>
    ...
    <div class="box-body">
        <form action="javascript:void(0)" id='FormData'>
            ...
            <div class="form-group">
                ...
                <input type="text" placeholder="Entri Nama Mitra" name='nama_mitra' id='nama_mitra' class='form-control'>
            </div>
            <div class="form-group">
                ...
                <select name="id_jenis_mitra" id="id_jenis_mitra"  class="form-control select-jenis-mitra">
                    ...
                    @foreach($jenis_mitra as $key => $dt_jenis_mitra)
                        <option  value="{{ $dt_jenis_mitra->id }}">{{ $dt_jenis_mitra->nama_jenis_mitra }}</option>
            ...
            <div class="form-group">
                ...
                <input type="text" placeholder="Entri No Telepon" name='no_tlp' id='no_tlp' class='form-control'>
            </div>

            <div class="form-group">
                <label for="website" autocomplete=off class='control-label'>Website</label>
                <input type="text" placeholder="Entri Website" name='website' id='website' class='form-control'>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" placeholder="Entri Alamat" name='alamat' id='alamat' class='form-control'>
            </div>
