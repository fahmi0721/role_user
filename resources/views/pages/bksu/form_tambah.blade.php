@extends("master_lte")
@section("title-page", "Tambah Master Bentuk Kerja Sama Umum")
...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active"><i class="fa fa-plus-square"></i> Tambah Master Bentuk Kerja Sama Umum</li>
  </ol>
</section>
@endsection
...
<div class="box box-success">
    <div class="box-header with-border ">
        <h3 class="box-title"><i class='fa fa-plus-square text-success'></i> Tambah Data Bentuk Kerjasama Umum</h3>
    ...
    <div class="box-body">
        <form action="javascript:void(0)" id='FormData'>
            ...
            <div class="form-group">
                ...
                <input type="text" placeholder="Entri Bentuk Kerjasama Umum" name='nama_bentuk_kerjasam_umum' id='nama_bentuk_kerjasam_umum' class='form-control FormIsi'>
            </div>
            <div class="form-group">
                <label for="penjelasan_bentuk_kerjasam_umum" class='control-label'>Penjelasan Bentuk Kerjasama Umum</label>
                <textarea type="text" placeholder="Entri Penjelasan Bentuk Kerjasama Umum"  name='penjelasan_bentuk_kerjasam_umum' id='penjelasan_bentuk_kerjasam_umum' class='form-control' rows='8'></textarea>
            </div>
